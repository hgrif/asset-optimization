...
4. System reports which interventions were selected and why
...
3. User can compare 2-3 scenarios side-by-side
...
**Key Decisions:**
- Python SDK first, UI later — Consultants need flexibility; templated UI can wrap SDK
- scikit-learn style API — Balance of OOP and functional, familiar to data scientists
- Water pipes for v1 — Concrete domain to validate architecture before generalizing
- Weibull deterioration model — Well-understood statistical model, good starting point
- Pluggable optimizer interface — Start with heuristics, swap in MILP when needed
- DataFrame-first portfolio API — Remove Portfolio class, treat portfolios as DataFrames
- Always-on asset history — Track per-asset events by default for traceability
