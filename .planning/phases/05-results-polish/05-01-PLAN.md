...
Purpose: Enable users to export intervention schedules and cost projections to parquet format (OUTP-01, OUTP-02, OUTP-05)
...
Add necessary imports: `from pathlib import Path` (Union and Optional already imported).
