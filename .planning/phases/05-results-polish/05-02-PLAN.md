...
must_haves:
  truths:
    ...
    - "User can generate a 'do nothing' baseline without manually creating one"
  artifacts:
    - path: "src/asset_optimization/scenarios.py"
      provides: "Scenario comparison utilities"
      exports: ["compare_scenarios", "create_do_nothing_baseline", "compare"]
  key_links:
...
- Auto-baseline: User can generate a baseline without manual creation
