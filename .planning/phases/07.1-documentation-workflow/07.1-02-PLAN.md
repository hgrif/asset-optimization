...
files_modified:
  ...
  - notebooks/02_proportional_hazards.ipynb
autonomous: true
...
<task type="auto">
  ...
  <files>notebooks/01_quickstart.ipynb, notebooks/02_proportional_hazards.ipynb</files>
  <action>
