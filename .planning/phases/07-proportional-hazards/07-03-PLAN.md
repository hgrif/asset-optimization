...
years = list(range(1, config.n_years + 1))
baseline_failures = [result_baseline.yearly_summaries[y]['failures'] for y in years]
ph_failures = [result_ph.yearly_summaries[y]['failures'] for y in years]
...
baseline_cumcost = np.cumsum([result_baseline.yearly_summaries[y]['total_cost'] for y in years])
ph_cumcost = np.cumsum([result_ph.yearly_summaries[y]['total_cost'] for y in years])
