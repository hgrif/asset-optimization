...
<task type="auto">
  ...
  <action>
Add OptimizationError class following SimulationError pattern:
...
Place after SimulationError class (maintain alphabetical-ish grouping by domain).
  ...
  <verify>
python -c "from asset_optimization.exceptions import OptimizationError; e = OptimizationError('test', {'budget': 1000}); print(str(e))"
  </verify>
  <done>
OptimizationError raises with message and optional details dict, formatted like SimulationError
  </done>
</task>
...
3. All existing tests still pass: `pytest tests/ -q`
</verification>
